...
<br>
<div align="center">
	 <button onclick="location.href='http://localhost//ShuttleCabmgmtsys/homepage_safar.php'" type="button" class="btn btn-primary" value="back">Back</button>
</div>
    ...
    <div class="feedback-faces">
      <div class="row">
        ...
        <div class="face-wrapper slide-out-y-alt">
          ...
          <label class="face grayscale face-disappointed" for="rate-1" data-hint="Not Satisfactory...">
            <div class="eyes-wrapper">
              <div class="eye">
                <div class="pupil">
                  <div class="eyelid"></div>
